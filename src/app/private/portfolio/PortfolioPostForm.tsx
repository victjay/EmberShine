        ...
        <div className="flex gap-4">
          ...
          <div className="flex flex-col gap-1">
            ...
            <select
              name="status"
              required
              defaultValue={defaultValues.status ?? 'Shipped'}
              className="text-sm border border-slate-200 rounded px-3 py-1.5 font-mono focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white"
            >
